...
func (c *greeterServiceClient) SayHello(ctx context.Context, in *SayHelloRequest, opts ...grpc.CallOption) (*GreeterServiceSayHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.gateway.v1.GreeterService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GreeterService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.gateway.v1.GreeterService/SayHello",
	}
...
var GreeterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.gateway.v1.GreeterService",
	...
	Metadata: "proto/gateway/v1/greeting.proto",
}
